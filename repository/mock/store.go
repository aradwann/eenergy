...
// Source: github.com/aradwann/eenergy/repository/store (interfaces: Store)
//
...
func (m *MockStore) CreateVerifyEmail(arg0 context.Context, arg1 db.CreateVerifyEmail) (db.VerifyEmail, error) {
	m.ctrl.T.Helper()
